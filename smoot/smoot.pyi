...
class F64Unit:
    @staticmethod
    def parse(s: str) -> tuple[float, F64Unit]: ...
...
class F64Quantity:
    ...
    def to(self, units: str | F64Unit, *, factor: float | None = None) -> Self: ...
    def ito(self, units: str | F64Unit, *, factor: float | None = None) -> None: ...
    def m_as(self, units: str | F64Unit, *, factor: float | None = None) -> float: ...
...
class I64Quantity:
    ...
    def to(self, units: str | F64Unit, *, factor: float | None = None) -> Self: ...
    def ito(self, units: str | F64Unit, *, factor: float | None = None) -> None: ...
    def m_as(self, units: str | F64Unit, *, factor: float | None = None) -> int: ...
    def __eq__(self, other: Any) -> bool: ...
    def __add__(self, other: Self | Real) -> Self: ...
    def __sub__(self, other: Self | Real) -> Self: ...
    def __mul__(self, other: Self | Real) -> Self: ...
...
class ArrayF64Quantity:
    ...
    def ito(self, units: str | F64Unit, *, factor: float | None = None) -> None: ...
    def m_as(
        self, units: str | F64Unit, *, factor: float | None = None
    ) -> NDArray[np.float64]: ...
    def arr_pow(
        self, other: Self | NDArray[np.float64] | NDArray[np.int64]
    ) -> Self: ...
